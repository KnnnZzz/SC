...
sudo mount -t glusterfs 192.168.66.121:/storage/sql /cluster/sql

# Adicionar o ponto de montagem ao fstab para montagem automática na inicialização
echo "192.168.66.121:/storage/sql /cluster/sql glusterfs defaults,_netdev 0 0" | sudo tee -a /etc/fstab
